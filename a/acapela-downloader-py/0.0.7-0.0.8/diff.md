# Comparing `tmp/acapela_downloader_py-0.0.7.tar.gz` & `tmp/acapela_downloader_py-0.0.8.tar.gz`
...
## Comparing `acapela_downloader_py-0.0.7.tar` & `acapela_downloader_py-0.0.8.tar`
...
### Comparing `acapela_downloader_py-0.0.7/LICENSE` & `acapela_downloader_py-0.0.8/LICENSE`

 * *Files identical despite different names*

### Comparing `acapela_downloader_py-0.0.7/PKG-INFO` & `acapela_downloader_py-0.0.8/PKG-INFO`
...
### Comparing `acapela_downloader_py-0.0.7/src/acapela_downloader_py.egg-info/PKG-INFO` & `acapela_downloader_py-0.0.8/src/acapela_downloader_py.egg-info/PKG-INFO`
...
### Comparing `acapela_downloader_py-0.0.7/src/utils.py` & `acapela_downloader_py-0.0.8/src/utils.py`
