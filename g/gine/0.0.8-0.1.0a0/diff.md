# Comparing `tmp/gine-0.0.8.tar.gz` & `tmp/gine-0.1.0a0.tar.gz`

## filetype from file(1)

```diff
@@ -1 +1 @@
-gzip compressed data, was "gine-0.0.8.tar", last modified: Mon Jun 12 11:43:49 2023, max compression
+gzip compressed data, was "gine-0.1.0a0.tar", last modified: Sat Jun 10 15:56:48 2023, max compression
```

## Comparing `gine-0.0.8.tar` & `gine-0.1.0a0.tar`

### file list

```diff
@@ -1,52 +1,44 @@
-drwxr-xr-x   0 runner    (1001) docker     (123)        0 2023-06-12 11:43:49.439657 gine-0.0.8/
--rw-r--r--   0 runner    (1001) docker     (123)      466 2023-06-12 11:42:27.000000 gine-0.0.8/MANIFEST.in
--rw-r--r--   0 runner    (1001) docker     (123)     2472 2023-06-12 11:43:49.439657 gine-0.0.8/PKG-INFO
--rw-r--r--   0 runner    (1001) docker     (123)     1358 2023-06-12 11:42:27.000000 gine-0.0.8/README.md
-drwxr-xr-x   0 runner    (1001) docker     (123)        0 2023-06-12 11:43:49.435657 gine-0.0.8/gine/
--rw-r--r--   0 runner    (1001) docker     (123)     1737 2023-06-12 11:42:27.000000 gine-0.0.8/gine/__init__.py
--rw-r--r--   0 runner    (1001) docker     (123)       68 2023-06-12 11:42:27.000000 gine-0.0.8/gine/_version.py
--rw-r--r--   0 runner    (1001) docker     (123)     1279 2023-06-12 11:42:27.000000 gine-0.0.8/gine/example.py
-drwxr-xr-x   0 runner    (1001) docker     (123)        0 2023-06-12 11:43:49.435657 gine-0.0.8/gine/labextension/
--rw-r--r--   0 runner    (1001) docker     (123)     1877 2023-06-12 11:43:48.000000 gine-0.0.8/gine/labextension/package.json
-drwxr-xr-x   0 runner    (1001) docker     (123)        0 2023-06-12 11:43:49.435657 gine-0.0.8/gine/labextension/static/
--rw-r--r--   0 runner    (1001) docker     (123)     4567 2023-06-12 11:43:48.000000 gine-0.0.8/gine/labextension/static/164.fb097ea067a2237492ad.js
--rw-r--r--   0 runner    (1001) docker     (123)   286997 2023-06-12 11:43:48.000000 gine-0.0.8/gine/labextension/static/628.12274283fa1c1c1213b9.js
--rw-r--r--   0 runner    (1001) docker     (123)     4935 2023-06-12 11:43:48.000000 gine-0.0.8/gine/labextension/static/908.d24cfb60440b4a333371.js
--rw-r--r--   0 runner    (1001) docker     (123)     6801 2023-06-12 11:43:48.000000 gine-0.0.8/gine/labextension/static/remoteEntry.84fde6212e5f79e2e175.js
--rw-r--r--   0 runner    (1001) docker     (123)      118 2023-06-12 11:43:39.000000 gine-0.0.8/gine/labextension/static/style.js
--rw-r--r--   0 runner    (1001) docker     (123)    32732 2023-06-12 11:43:48.000000 gine-0.0.8/gine/labextension/static/third-party-licenses.json
-drwxr-xr-x   0 runner    (1001) docker     (123)        0 2023-06-12 11:43:49.435657 gine-0.0.8/gine/nbextension/
--rw-r--r--   0 runner    (1001) docker     (123)      517 2023-06-12 11:43:14.000000 gine-0.0.8/gine/nbextension/extension.js
--rw-r--r--   0 runner    (1001) docker     (123)    58990 2023-06-12 11:43:19.000000 gine-0.0.8/gine/nbextension/index.js
--rw-r--r--   0 runner    (1001) docker     (123)     1448 2023-06-12 11:42:27.000000 gine-0.0.8/gine/netlist_graph.py
--rw-r--r--   0 runner    (1001) docker     (123)     1941 2023-06-12 11:42:27.000000 gine-0.0.8/gine/utils.py
-drwxr-xr-x   0 runner    (1001) docker     (123)        0 2023-06-12 11:43:49.435657 gine-0.0.8/gine.egg-info/
--rw-r--r--   0 runner    (1001) docker     (123)     2472 2023-06-12 11:43:49.000000 gine-0.0.8/gine.egg-info/PKG-INFO
--rw-r--r--   0 runner    (1001) docker     (123)     1004 2023-06-12 11:43:49.000000 gine-0.0.8/gine.egg-info/SOURCES.txt
--rw-r--r--   0 runner    (1001) docker     (123)        1 2023-06-12 11:43:49.000000 gine-0.0.8/gine.egg-info/dependency_links.txt
--rw-r--r--   0 runner    (1001) docker     (123)        1 2023-06-12 11:43:01.000000 gine-0.0.8/gine.egg-info/not-zip-safe
--rw-r--r--   0 runner    (1001) docker     (123)       87 2023-06-12 11:43:49.000000 gine-0.0.8/gine.egg-info/requires.txt
--rw-r--r--   0 runner    (1001) docker     (123)        5 2023-06-12 11:43:49.000000 gine-0.0.8/gine.egg-info/top_level.txt
--rw-r--r--   0 runner    (1001) docker     (123)       58 2023-06-12 11:42:27.000000 gine-0.0.8/gine.json
--rw-r--r--   0 runner    (1001) docker     (123)      168 2023-06-12 11:42:27.000000 gine-0.0.8/install.json
-drwxr-xr-x   0 runner    (1001) docker     (123)        0 2023-06-12 11:43:49.435657 gine-0.0.8/js/
--rw-r--r--   0 runner    (1001) docker     (123)      185 2023-06-12 11:42:27.000000 gine-0.0.8/js/README.md
--rw-r--r--   0 runner    (1001) docker     (123)      647 2023-06-12 11:42:27.000000 gine-0.0.8/js/amd-public-path.js
-drwxr-xr-x   0 runner    (1001) docker     (123)        0 2023-06-12 11:43:49.435657 gine-0.0.8/js/dist/
--rw-r--r--   0 runner    (1001) docker     (123)    58990 2023-06-12 11:43:19.000000 gine-0.0.8/js/dist/index.js
--rw-r--r--   0 runner    (1001) docker     (123)   213119 2023-06-12 11:42:27.000000 gine-0.0.8/js/package-lock.json
--rw-r--r--   0 runner    (1001) docker     (123)     1761 2023-06-12 11:42:27.000000 gine-0.0.8/js/package.json
-drwxr-xr-x   0 runner    (1001) docker     (123)        0 2023-06-12 11:43:49.439657 gine-0.0.8/js/src/
--rw-r--r--   0 runner    (1001) docker     (123)     8200 2023-06-12 11:42:27.000000 gine-0.0.8/js/src/NetlistGraph.js
--rw-r--r--   0 runner    (1001) docker     (123)     2356 2023-06-12 11:42:27.000000 gine-0.0.8/js/src/NetlistGraphWidget.js
--rw-r--r--   0 runner    (1001) docker     (123)     1257 2023-06-12 11:42:27.000000 gine-0.0.8/js/src/example.js
--rw-r--r--   0 runner    (1001) docker     (123)      445 2023-06-12 11:42:27.000000 gine-0.0.8/js/src/extension.js
--rw-r--r--   0 runner    (1001) docker     (123)      235 2023-06-12 11:42:27.000000 gine-0.0.8/js/src/index.js
--rw-r--r--   0 runner    (1001) docker     (123)      569 2023-06-12 11:42:27.000000 gine-0.0.8/js/src/labplugin.js
--rw-r--r--   0 runner    (1001) docker     (123)     2807 2023-06-12 11:42:27.000000 gine-0.0.8/js/webpack.config.js
--rw-r--r--   0 runner    (1001) docker     (123)   118565 2023-06-12 11:42:27.000000 gine-0.0.8/js/yarn.lock
--rw-r--r--   0 runner    (1001) docker     (123)      145 2023-06-12 11:42:27.000000 gine-0.0.8/pyproject.toml
--rw-r--r--   0 runner    (1001) docker     (123)     1456 2023-06-12 11:43:49.439657 gine-0.0.8/setup.cfg
--rw-r--r--   0 runner    (1001) docker     (123)      879 2023-06-12 11:42:27.000000 gine-0.0.8/setup.py
-drwxr-xr-x   0 runner    (1001) docker     (123)        0 2023-06-12 11:43:49.439657 gine-0.0.8/tests/
--rw-r--r--   0 runner    (1001) docker     (123)      718 2023-06-12 11:42:27.000000 gine-0.0.8/tests/test_netlist_conversion.py
...
### Comparing `gine-0.0.8/PKG-INFO` & `gine-0.1.0a0/PKG-INFO`
...
### Comparing `gine-0.0.8/gine/__init__.py` & `gine-0.1.0a0/gine/__init__.py`
...
### Comparing `gine-0.0.8/gine/example.py` & `gine-0.1.0a0/gine/example.py`
...
### Comparing `gine-0.0.8/gine/labextension/package.json` & `gine-0.1.0a0/js/package.json`

 * *Files 22% similar despite different names*

#### Pretty-printed

 * *Similarity: 0.8217948717948718%*
 ...
 * * "'jupyterlab'": "{'extension': 'lib/labplugin', delete: ['_build']}",*
...
-        "_build": {
-            "extension": "./extension",
-            "load": "static/remoteEntry.84fde6212e5f79e2e175.js"
-        },
...
### Comparing `gine-0.0.8/gine/labextension/static/remoteEntry.84fde6212e5f79e2e175.js` & `gine-0.1.0a0/gine/labextension/static/remoteEntry.3963689fdfb3bdc58b8e.js`
...
@@ -1,15 +1,15 @@
 ...
 (() => {
     "use strict";
-    var e, r, t, n, o, a, i, u, l, s, f, d, c, p, h, v, g, b, m, y = {
-            535: (e, r, t) => {
+    var e, r, t, n, o, a, i, u, f, l, s, d, c, p, h, v, g = {
+            846: (e, r, t) => {
                 var n = {
-                        "./index": () => Promise.all([t.e(242), t.e(164)]).then((() => () => t(164))),
-                        "./extension": () => Promise.all([t.e(242), t.e(908)]).then((() => () => t(908)))
...
-        164: "fb097ea067a2237492ad",
-        242: "00eae9ca570934f4e222",
-        628: "12274283fa1c1c1213b9",
-        908: "d24cfb60440b4a333371"
...
-                    },
-                    l = [];
-                return "default" === t && (u("d3", "7.8.5", (() => S.e(628).then((() => () => S(628))))), u("gine", "0.0.8", (() => Promise.all([S.e(242), S.e(164)]).then((() => () => S(164)))))), e[t] = l.length ? Promise.all(l).then((() => e[t] = 1)) : 1
+                    u = [];
...
-        return a ? c(a) : o()
-    })), g = {}, b = {
-        407: () => v("default", "d3", [1, 7, 8, 4], (() => S.e(628).then((() => () => S(628))))),
...
### Comparing `gine-0.0.8/gine/nbextension/extension.js` & `gine-0.1.0a0/gine/nbextension/extension.js`

 * *Files identical despite different names*

### Comparing `gine-0.0.8/gine.egg-info/PKG-INFO` & `gine-0.1.0a0/gine.egg-info/PKG-INFO`
...
### Comparing `gine-0.0.8/js/amd-public-path.js` & `gine-0.1.0a0/js/amd-public-path.js`
...
### Comparing `gine-0.0.8/js/package.json` & `gine-0.1.0a0/gine/labextension/package.json`
 ...
 * * "'jupyterlab'": "{'extension': 'lib/labplugin', '_build': OrderedDict([('load', "*
...
### Comparing `gine-0.0.8/js/src/example.js` & `gine-0.1.0a0/js/lib/example.js`
...
### Comparing `gine-0.0.8/setup.cfg` & `gine-0.1.0a0/setup.cfg`
...
### Comparing `gine-0.0.8/setup.py` & `gine-0.1.0a0/setup.py`
