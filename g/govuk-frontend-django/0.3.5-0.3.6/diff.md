# Comparing `tmp/govuk_frontend_django-0.3.5.tar.gz` & `tmp/govuk_frontend_django-0.3.6.tar.gz`
...
### Comparing `govuk_frontend_django-0.3.5/LICENSE` & `govuk_frontend_django-0.3.6/LICENSE`
