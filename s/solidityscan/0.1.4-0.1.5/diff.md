# Comparing `tmp/solidityscan-0.1.4.tar.gz` & `tmp/solidityscan-0.1.5.tar.gz`
...
+gzip compressed data, was "solidityscan-0.1.5.tar", last modified: Mon Jun 12 12:36:27 2023, max compression
```

## Comparing `solidityscan-0.1.4.tar` & `solidityscan-0.1.5.tar`
...
+drwxr-xr-x   0 manosriram   (501) staff       (20)        0 2023-06-12 12:36:27.493755 solidityscan-0.1.5/
+-rw-r--r--   0 manosriram   (501) staff       (20)      272 2023-06-12 12:36:27.493628 solidityscan-0.1.5/PKG-INFO
+-rw-r--r--   0 manosriram   (501) staff       (20)       55 2023-05-15 17:56:15.000000 solidityscan-0.1.5/README.md
+-rw-r--r--   0 manosriram   (501) staff       (20)       38 2023-06-12 12:36:27.493789 solidityscan-0.1.5/setup.cfg
+-rw-r--r--   0 manosriram   (501) staff       (20)     1290 2023-06-12 12:36:20.000000 solidityscan-0.1.5/setup.py
+drwxr-xr-x   0 manosriram   (501) staff       (20)        0 2023-06-12 12:36:27.492691 solidityscan-0.1.5/solidityscan.egg-info/
+-rw-r--r--   0 manosriram   (501) staff       (20)      272 2023-06-12 12:36:27.000000 solidityscan-0.1.5/solidityscan.egg-info/PKG-INFO
+-rw-r--r--   0 manosriram   (501) staff       (20)      444 2023-06-12 12:36:27.000000 solidityscan-0.1.5/solidityscan.egg-info/SOURCES.txt
+-rw-r--r--   0 manosriram   (501) staff       (20)        1 2023-06-12 12:36:27.000000 solidityscan-0.1.5/solidityscan.egg-info/dependency_links.txt
+-rw-r--r--   0 manosriram   (501) staff       (20)       74 2023-06-12 12:36:27.000000 solidityscan-0.1.5/solidityscan.egg-info/entry_points.txt
+-rw-r--r--   0 manosriram   (501) staff       (20)      387 2023-06-12 12:36:27.000000 solidityscan-0.1.5/solidityscan.egg-info/requires.txt
+-rw-r--r--   0 manosriram   (501) staff       (20)       19 2023-06-12 12:36:27.000000 solidityscan-0.1.5/solidityscan.egg-info/top_level.txt
+drwxr-xr-x   0 manosriram   (501) staff       (20)        0 2023-06-12 12:36:27.493477 solidityscan-0.1.5/solidityscan_agent/
+-rw-r--r--   0 manosriram   (501) staff       (20)     4042 2023-06-12 12:35:12.000000 solidityscan-0.1.5/solidityscan_agent/__init__.py
+-rw-r--r--   0 manosriram   (501) staff       (20)     1833 2023-06-12 12:35:16.000000 solidityscan-0.1.5/solidityscan_agent/config.py
+-rw-r--r--   0 manosriram   (501) staff       (20)      211 2023-06-06 06:05:13.000000 solidityscan-0.1.5/solidityscan_agent/constants.py
+-rw-r--r--   0 manosriram   (501) staff       (20)     1606 2023-06-12 12:25:13.000000 solidityscan-0.1.5/solidityscan_agent/exceptions.py
+-rw-r--r--   0 manosriram   (501) staff       (20)      916 2023-06-12 12:35:24.000000 solidityscan-0.1.5/solidityscan_agent/lang.py
+-rw-r--r--   0 manosriram   (501) staff       (20)     1217 2023-06-12 12:35:34.000000 solidityscan-0.1.5/solidityscan_agent/report.py
+-rw-r--r--   0 manosriram   (501) staff       (20)     2872 2023-06-12 12:35:41.000000 solidityscan-0.1.5/solidityscan_agent/scan.py
```

### Comparing `solidityscan-0.1.4/setup.py` & `solidityscan-0.1.5/setup.py`
...
### Comparing `solidityscan-0.1.4/solidityscan_agent/__init__.py` & `solidityscan-0.1.5/solidityscan_agent/__init__.py`
...
### Comparing `solidityscan-0.1.4/solidityscan_agent/config.py` & `solidityscan-0.1.5/solidityscan_agent/config.py`

 * *Files identical despite different names*

### Comparing `solidityscan-0.1.4/solidityscan_agent/exceptions.py` & `solidityscan-0.1.5/solidityscan_agent/exceptions.py`
...
### Comparing `solidityscan-0.1.4/solidityscan_agent/lang.py` & `solidityscan-0.1.5/solidityscan_agent/lang.py`

 * *Files identical despite different names*

### Comparing `solidityscan-0.1.4/solidityscan_agent/scan.py` & `solidityscan-0.1.5/solidityscan_agent/scan.py`
