# Comparing `tmp/SMjour-0.0.2.tar.gz` & `tmp/SMjour-0.0.3.tar.gz`
...
## Comparing `SMjour-0.0.2.tar` & `SMjour-0.0.3.tar`
...
### Comparing `SMjour-0.0.2/LICENSE` & `SMjour-0.0.3/LICENSE`

 * *Files identical despite different names*

### Comparing `SMjour-0.0.2/SMjour/SMjour.py` & `SMjour-0.0.3/SMjour/SMjour.py`
...
### Comparing `SMjour-0.0.2/setup.cfg` & `SMjour-0.0.3/setup.cfg`
