# Comparing `tmp/SmoobuExtractorFormatter-1.2.4.tar.gz` & `tmp/SmoobuExtractorFormatter-1.2.5.tar.gz`
...
## Comparing `SmoobuExtractorFormatter-1.2.4.tar` & `SmoobuExtractorFormatter-1.2.5.tar`
...
### Comparing `SmoobuExtractorFormatter-1.2.4/LICENSE.txt` & `SmoobuExtractorFormatter-1.2.5/LICENSE.txt`

 * *Files identical despite different names*

### Comparing `SmoobuExtractorFormatter-1.2.4/PKG-INFO` & `SmoobuExtractorFormatter-1.2.5/PKG-INFO`
...
### Comparing `SmoobuExtractorFormatter-1.2.4/SmoobuExtractorFormatter/smoobuOutput.py` & `SmoobuExtractorFormatter-1.2.5/SmoobuExtractorFormatter/smoobuOutput.py`
...
### Comparing `SmoobuExtractorFormatter-1.2.4/SmoobuExtractorFormatter.egg-info/PKG-INFO` & `SmoobuExtractorFormatter-1.2.5/SmoobuExtractorFormatter.egg-info/PKG-INFO`
...
### Comparing `SmoobuExtractorFormatter-1.2.4/setup.py` & `SmoobuExtractorFormatter-1.2.5/setup.py`
