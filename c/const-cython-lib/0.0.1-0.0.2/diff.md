# Comparing `tmp/const_cython_lib-0.0.1.tar.gz` & `tmp/const_cython_lib-0.0.2.tar.gz`

## filetype from file(1)

```diff
@@ -1 +1 @@
-gzip compressed data, was "const_cython_lib-0.0.1.tar", last modified: Mon Jun 12 09:45:07 2023, max compression
+gzip compressed data, was "const_cython_lib-0.0.2.tar", last modified: Mon Jun 12 09:49:04 2023, max compression
```

## Comparing `const_cython_lib-0.0.1.tar` & `const_cython_lib-0.0.2.tar`

### file list

```diff
@@ -1,14 +1,14 @@
-drwxr-xr-x   0 lysnikolaou   (501) staff       (20)        0 2023-06-12 09:45:07.919828 const_cython_lib-0.0.1/
--rw-r--r--   0 lysnikolaou   (501) staff       (20)       29 2023-06-12 09:16:54.000000 const_cython_lib-0.0.1/MANIFEST.in
--rw-r--r--   0 lysnikolaou   (501) staff       (20)      133 2023-06-12 09:45:07.919677 const_cython_lib-0.0.1/PKG-INFO
--rw-r--r--   0 lysnikolaou   (501) staff       (20)   109577 2023-06-12 09:45:07.000000 const_cython_lib-0.0.1/const_cython_lib.c
-drwxr-xr-x   0 lysnikolaou   (501) staff       (20)        0 2023-06-12 09:45:07.919484 const_cython_lib-0.0.1/const_cython_lib.egg-info/
--rw-r--r--   0 lysnikolaou   (501) staff       (20)      133 2023-06-12 09:45:07.000000 const_cython_lib-0.0.1/const_cython_lib.egg-info/PKG-INFO
--rw-r--r--   0 lysnikolaou   (501) staff       (20)      274 2023-06-12 09:45:07.000000 const_cython_lib-0.0.1/const_cython_lib.egg-info/SOURCES.txt
--rw-r--r--   0 lysnikolaou   (501) staff       (20)        1 2023-06-12 09:45:07.000000 const_cython_lib-0.0.1/const_cython_lib.egg-info/dependency_links.txt
--rw-r--r--   0 lysnikolaou   (501) staff       (20)        1 2023-06-12 09:45:07.000000 const_cython_lib-0.0.1/const_cython_lib.egg-info/not-zip-safe
--rw-r--r--   0 lysnikolaou   (501) staff       (20)       17 2023-06-12 09:45:07.000000 const_cython_lib-0.0.1/const_cython_lib.egg-info/top_level.txt
--rw-r--r--   0 lysnikolaou   (501) staff       (20)       48 2023-06-12 09:15:36.000000 const_cython_lib-0.0.1/const_cython_lib.pyx
--rw-r--r--   0 lysnikolaou   (501) staff       (20)      229 2023-06-12 09:40:15.000000 const_cython_lib-0.0.1/pyproject.toml
--rw-r--r--   0 lysnikolaou   (501) staff       (20)       38 2023-06-12 09:45:07.919872 const_cython_lib-0.0.1/setup.cfg
--rw-r--r--   0 lysnikolaou   (501) staff       (20)      265 2023-06-12 09:12:18.000000 const_cython_lib-0.0.1/setup.py
...
### Comparing `const_cython_lib-0.0.1/const_cython_lib.c` & `const_cython_lib-0.0.2/const_cython_lib.c`
