# Comparing `tmp/const_cython_lib-0.2.0.tar.gz` & `tmp/const_cython_lib-0.2.1.tar.gz`
...
+gzip compressed data, was "const_cython_lib-0.2.1.tar", last modified: Mon Jun 12 13:22:17 2023, max compression
```

## Comparing `const_cython_lib-0.2.0.tar` & `const_cython_lib-0.2.1.tar`
...
+drwxr-xr-x   0 lysnikolaou   (501) staff       (20)        0 2023-06-12 13:22:17.592589 const_cython_lib-0.2.1/
+-rw-r--r--   0 lysnikolaou   (501) staff       (20)      133 2023-06-12 13:22:17.592453 const_cython_lib-0.2.1/PKG-INFO
+drwxr-xr-x   0 lysnikolaou   (501) staff       (20)        0 2023-06-12 13:22:17.591553 const_cython_lib-0.2.1/const_cython_lib/
+-rw-r--r--   0 lysnikolaou   (501) staff       (20)        0 2023-06-12 13:06:05.000000 const_cython_lib-0.2.1/const_cython_lib/__init__.py
+-rw-r--r--   0 lysnikolaou   (501) staff       (20)   119108 2023-06-12 13:22:17.000000 const_cython_lib-0.2.1/const_cython_lib/lsum.c
+-rw-r--r--   0 lysnikolaou   (501) staff       (20)      811 2023-06-12 13:22:17.000000 const_cython_lib-0.2.1/const_cython_lib/lsum.h
+-rw-r--r--   0 lysnikolaou   (501) staff       (20)       32 2023-06-12 13:22:13.000000 const_cython_lib-0.2.1/const_cython_lib/lsum.pxd
+-rw-r--r--   0 lysnikolaou   (501) staff       (20)       50 2023-06-12 13:22:13.000000 const_cython_lib-0.2.1/const_cython_lib/lsum.pyx
+drwxr-xr-x   0 lysnikolaou   (501) staff       (20)        0 2023-06-12 13:22:17.592258 const_cython_lib-0.2.1/const_cython_lib.egg-info/
+-rw-r--r--   0 lysnikolaou   (501) staff       (20)      133 2023-06-12 13:22:17.000000 const_cython_lib-0.2.1/const_cython_lib.egg-info/PKG-INFO
+-rw-r--r--   0 lysnikolaou   (501) staff       (20)      351 2023-06-12 13:22:17.000000 const_cython_lib-0.2.1/const_cython_lib.egg-info/SOURCES.txt
+-rw-r--r--   0 lysnikolaou   (501) staff       (20)        1 2023-06-12 13:22:17.000000 const_cython_lib-0.2.1/const_cython_lib.egg-info/dependency_links.txt
+-rw-r--r--   0 lysnikolaou   (501) staff       (20)        1 2023-06-12 13:22:17.000000 const_cython_lib-0.2.1/const_cython_lib.egg-info/not-zip-safe
+-rw-r--r--   0 lysnikolaou   (501) staff       (20)       17 2023-06-12 13:22:17.000000 const_cython_lib-0.2.1/const_cython_lib.egg-info/top_level.txt
+-rw-r--r--   0 lysnikolaou   (501) staff       (20)      229 2023-06-12 13:09:11.000000 const_cython_lib-0.2.1/pyproject.toml
+-rw-r--r--   0 lysnikolaou   (501) staff       (20)       38 2023-06-12 13:22:17.592648 const_cython_lib-0.2.1/setup.cfg
+-rw-r--r--   0 lysnikolaou   (501) staff       (20)      376 2023-06-12 13:13:37.000000 const_cython_lib-0.2.1/setup.py
```

### Comparing `const_cython_lib-0.2.0/const_cython_lib/lsum.c` & `const_cython_lib-0.2.1/const_cython_lib/lsum.c`
...
### Comparing `const_cython_lib-0.2.0/const_cython_lib/lsum.h` & `const_cython_lib-0.2.1/const_cython_lib/lsum.h`
