# Comparing `tmp/const_cython_lib-0.1.0.tar.gz` & `tmp/const_cython_lib-0.1.1.tar.gz`

## filetype from file(1)

```diff
@@ -1 +1 @@
-gzip compressed data, was "const_cython_lib-0.1.0.tar", last modified: Mon Jun 12 12:01:54 2023, max compression
+gzip compressed data, was "const_cython_lib-0.1.1.tar", last modified: Mon Jun 12 12:03:07 2023, max compression
```

## Comparing `const_cython_lib-0.1.0.tar` & `const_cython_lib-0.1.1.tar`

### file list

```diff
@@ -1,16 +1,16 @@
-drwxr-xr-x   0 lysnikolaou   (501) staff       (20)        0 2023-06-12 12:01:54.783475 const_cython_lib-0.1.0/
--rw-r--r--   0 lysnikolaou   (501) staff       (20)      133 2023-06-12 12:01:54.783320 const_cython_lib-0.1.0/PKG-INFO
-drwxr-xr-x   0 lysnikolaou   (501) staff       (20)        0 2023-06-12 12:01:54.782132 const_cython_lib-0.1.0/const_cython_lib/
--rw-r--r--   0 lysnikolaou   (501) staff       (20)   119182 2023-06-12 12:01:54.000000 const_cython_lib-0.1.0/const_cython_lib/lsum.c
--rw-r--r--   0 lysnikolaou   (501) staff       (20)      825 2023-06-12 12:01:54.000000 const_cython_lib-0.1.0/const_cython_lib/lsum.h
--rw-r--r--   0 lysnikolaou   (501) staff       (20)       44 2023-06-12 11:55:07.000000 const_cython_lib-0.1.0/const_cython_lib/lsum.pxd
--rw-r--r--   0 lysnikolaou   (501) staff       (20)       62 2023-06-12 12:01:41.000000 const_cython_lib-0.1.0/const_cython_lib/lsum.pyx
-drwxr-xr-x   0 lysnikolaou   (501) staff       (20)        0 2023-06-12 12:01:54.783084 const_cython_lib-0.1.0/const_cython_lib.egg-info/
--rw-r--r--   0 lysnikolaou   (501) staff       (20)      133 2023-06-12 12:01:54.000000 const_cython_lib-0.1.0/const_cython_lib.egg-info/PKG-INFO
--rw-r--r--   0 lysnikolaou   (501) staff       (20)      322 2023-06-12 12:01:54.000000 const_cython_lib-0.1.0/const_cython_lib.egg-info/SOURCES.txt
--rw-r--r--   0 lysnikolaou   (501) staff       (20)        1 2023-06-12 12:01:54.000000 const_cython_lib-0.1.0/const_cython_lib.egg-info/dependency_links.txt
--rw-r--r--   0 lysnikolaou   (501) staff       (20)        1 2023-06-12 11:52:57.000000 const_cython_lib-0.1.0/const_cython_lib.egg-info/not-zip-safe
--rw-r--r--   0 lysnikolaou   (501) staff       (20)       17 2023-06-12 12:01:54.000000 const_cython_lib-0.1.0/const_cython_lib.egg-info/top_level.txt
--rw-r--r--   0 lysnikolaou   (501) staff       (20)      229 2023-06-12 11:52:16.000000 const_cython_lib-0.1.0/pyproject.toml
--rw-r--r--   0 lysnikolaou   (501) staff       (20)       38 2023-06-12 12:01:54.783516 const_cython_lib-0.1.0/setup.cfg
--rw-r--r--   0 lysnikolaou   (501) staff       (20)      364 2023-06-12 11:52:46.000000 const_cython_lib-0.1.0/setup.py
...
### Comparing `const_cython_lib-0.1.0/const_cython_lib/lsum.c` & `const_cython_lib-0.1.1/const_cython_lib/lsum.c`
...
### Comparing `const_cython_lib-0.1.0/const_cython_lib/lsum.h` & `const_cython_lib-0.1.1/const_cython_lib/lsum.h`
