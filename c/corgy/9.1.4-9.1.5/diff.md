# Comparing `tmp/corgy-9.1.4.tar.gz` & `tmp/corgy-9.1.5.tar.gz`
...
### Comparing `corgy-9.1.4/LICENSE` & `corgy-9.1.5/LICENSE`
...
### Comparing `corgy-9.1.4/corgy/types/_inputfile.py` & `corgy-9.1.5/corgy/types/_inputfile.py`
