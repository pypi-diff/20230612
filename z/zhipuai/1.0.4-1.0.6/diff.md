# Comparing `tmp/zhipuai-1.0.4.tar.gz` & `tmp/zhipuai-1.0.6.tar.gz`
...
+gzip compressed data, was "zhipuai-1.0.6.tar", last modified: Mon Jun 12 11:31:31 2023, max compression
```

## Comparing `zhipuai-1.0.4.tar` & `zhipuai-1.0.6.tar`
...
+drwxr-xr-x   0 haowangai   (501) staff       (20)        0 2023-06-12 11:31:31.967819 zhipuai-1.0.6/
+-rw-r--r--   0 haowangai   (501) staff       (20)      488 2023-06-12 11:31:31.967644 zhipuai-1.0.6/PKG-INFO
+-rw-r--r--   0 haowangai   (501) staff       (20)       11 2023-04-26 12:22:24.000000 zhipuai-1.0.6/README.md
+-rw-r--r--   0 haowangai   (501) staff       (20)       38 2023-06-12 11:31:31.967857 zhipuai-1.0.6/setup.cfg
+-rw-r--r--   0 haowangai   (501) staff       (20)      899 2023-06-12 11:31:14.000000 zhipuai-1.0.6/setup.py
+drwxr-xr-x   0 haowangai   (501) staff       (20)        0 2023-06-12 11:31:31.964403 zhipuai-1.0.6/zhipuai/
+-rw-r--r--   0 haowangai   (501) staff       (20)      221 2023-06-08 03:38:31.000000 zhipuai-1.0.6/zhipuai/__init__.py
+drwxr-xr-x   0 haowangai   (501) staff       (20)        0 2023-06-12 11:31:31.965762 zhipuai-1.0.6/zhipuai/examples/
+-rw-r--r--   0 haowangai   (501) staff       (20)        0 2023-06-08 03:38:31.000000 zhipuai-1.0.6/zhipuai/examples/__init__.py
+-rw-r--r--   0 haowangai   (501) staff       (20)     1466 2023-06-08 03:38:31.000000 zhipuai-1.0.6/zhipuai/examples/chatglm6b_example.py
+-rw-r--r--   0 haowangai   (501) staff       (20)     1427 2023-06-09 02:23:14.000000 zhipuai-1.0.6/zhipuai/examples/model_api_example.py
+drwxr-xr-x   0 haowangai   (501) staff       (20)        0 2023-06-12 11:31:31.966588 zhipuai-1.0.6/zhipuai/model_api/
+-rw-r--r--   0 haowangai   (501) staff       (20)      102 2023-06-08 03:38:31.000000 zhipuai-1.0.6/zhipuai/model_api/__init__.py
+-rw-r--r--   0 haowangai   (501) staff       (20)     1754 2023-06-12 10:36:58.000000 zhipuai-1.0.6/zhipuai/model_api/api.py
+-rw-r--r--   0 haowangai   (501) staff       (20)      246 2023-06-08 03:38:31.000000 zhipuai-1.0.6/zhipuai/model_api/chatglm_params.py
+-rw-r--r--   0 haowangai   (501) staff       (20)      272 2023-06-09 02:21:28.000000 zhipuai-1.0.6/zhipuai/model_api/params.py
+drwxr-xr-x   0 haowangai   (501) staff       (20)        0 2023-06-12 11:31:31.967333 zhipuai-1.0.6/zhipuai/utils/
+-rw-r--r--   0 haowangai   (501) staff       (20)        0 2023-06-05 13:56:33.000000 zhipuai-1.0.6/zhipuai/utils/__init__.py
+-rw-r--r--   0 haowangai   (501) staff       (20)     1432 2023-06-12 10:24:29.000000 zhipuai-1.0.6/zhipuai/utils/http_client.py
+-rw-r--r--   0 haowangai   (501) staff       (20)      700 2023-06-08 03:38:31.000000 zhipuai-1.0.6/zhipuai/utils/jwt_token.py
+-rw-r--r--   0 haowangai   (501) staff       (20)     4531 2023-06-08 10:53:33.000000 zhipuai-1.0.6/zhipuai/utils/sse_client.py
+drwxr-xr-x   0 haowangai   (501) staff       (20)        0 2023-06-12 11:31:31.965278 zhipuai-1.0.6/zhipuai.egg-info/
+-rw-r--r--   0 haowangai   (501) staff       (20)      488 2023-06-12 11:31:31.000000 zhipuai-1.0.6/zhipuai.egg-info/PKG-INFO
+-rw-r--r--   0 haowangai   (501) staff       (20)      526 2023-06-12 11:31:31.000000 zhipuai-1.0.6/zhipuai.egg-info/SOURCES.txt
+-rw-r--r--   0 haowangai   (501) staff       (20)        1 2023-06-12 11:31:31.000000 zhipuai-1.0.6/zhipuai.egg-info/dependency_links.txt
+-rw-r--r--   0 haowangai   (501) staff       (20)       48 2023-06-12 11:31:31.000000 zhipuai-1.0.6/zhipuai.egg-info/requires.txt
+-rw-r--r--   0 haowangai   (501) staff       (20)        8 2023-06-12 11:31:31.000000 zhipuai-1.0.6/zhipuai.egg-info/top_level.txt
```

### Comparing `zhipuai-1.0.4/setup.py` & `zhipuai-1.0.6/setup.py`
...
### Comparing `zhipuai-1.0.4/zhipuai/examples/chatglm6b_example.py` & `zhipuai-1.0.6/zhipuai/examples/chatglm6b_example.py`

 * *Files identical despite different names*

### Comparing `zhipuai-1.0.4/zhipuai/examples/model_api_example.py` & `zhipuai-1.0.6/zhipuai/examples/model_api_example.py`

 * *Files identical despite different names*

### Comparing `zhipuai-1.0.4/zhipuai/model_api/api.py` & `zhipuai-1.0.6/zhipuai/model_api/api.py`
...
### Comparing `zhipuai-1.0.4/zhipuai/utils/http_client.py` & `zhipuai-1.0.6/zhipuai/utils/http_client.py`
...
### Comparing `zhipuai-1.0.4/zhipuai/utils/jwt_token.py` & `zhipuai-1.0.6/zhipuai/utils/jwt_token.py`

 * *Files identical despite different names*

### Comparing `zhipuai-1.0.4/zhipuai/utils/sse_client.py` & `zhipuai-1.0.6/zhipuai/utils/sse_client.py`

 * *Files identical despite different names*

### Comparing `zhipuai-1.0.4/zhipuai.egg-info/SOURCES.txt` & `zhipuai-1.0.6/zhipuai.egg-info/SOURCES.txt`
